...
Examples:
----------------
â€¢ Converting a file-upload field into a Picup button:

    Picup.convertFileInput( fileInputField,  { 	'referrername' : escape('My Web App'),
                                             	'purpose'      : escape('Upload A Photo') });

â€¢ Opening an existing upload in the Picup app:

    Picup.openFileWithId('p12');                                            

â€¢ Generating a Picup URL:
...
â€¢ Defining a custom callback handler:
